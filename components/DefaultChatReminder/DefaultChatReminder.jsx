export const DefaultChatReminder =()=> {
    return(<div className="main px-xl-5 px-lg-4 px-3">
    ...
    <img className="avatar lg rounded-circle border" src="assets/images/user.png" alt="" />
...
export default DefaultChatReminder